            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <h3>Sosyal Medya Ayarları <small>
            <?php 
error_reporting(E_ERROR | E_PARSE);
 ...
 <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" value="<?php echo $ayarcek['ayar_twiter']; ?>"required="required" name="ayar_twiter" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" value="<?php echo $ayarcek['ayar_google']; ?>" required="required" name="ayar_google" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" value="<?php echo $ayarcek['ayar_youtube']; ?>" required="required" name="ayar_youtube" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       ...
                       <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button name="Sosyalayarlarıkaydet" type="submit" class="btn btn-success">Güncelle</button>
                        </div>
                    </form>
